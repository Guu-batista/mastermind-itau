...
var $, C, D, O, q, d, k, f, F, M, m, w, E, g, G, N, J, U, B, S, X, Z, z, b, x;
var init_dist = __esm({
  "node_modules/tinybench/dist/index.js"() {
    ...
    D = (s, n, t) => n in s ? $(s, n, { enumerable: true, configurable: true, writable: true, value: t }) : s[n] = t;
    O = (s, n, t) => D(s, typeof n != "symbol" ? n + "" : n, t);
    q = (s, n, t) => n.has(s) || C("Cannot " + t);
    d = (s, n, t) => (q(s, n, "read from private field"), t ? t.call(s) : n.get(s));
    k = (s, n, t) => n.has(s) ? C("Cannot add the same private member more than once") : n instanceof WeakSet ? n.add(s) : n.set(s, t);
    ...
    B = () => performance.now();
    S = (s, n) => s.reduce((e, r) => e + (r - n) ** 2, 0) / (s.length - 1) || 0;
    X = (() => __async(null, null, function* () {
    })).constructor;
    Z = (s) => s.constructor === X;
    z = (s) => __async(null, null, function* () {
      if (Z(s.fn))
        return true;
      try {
...
//# sourceMappingURL=chunk-JVQCR4B5.js.map
